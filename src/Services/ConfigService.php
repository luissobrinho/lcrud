...
class ConfigService
{
    ...
    public function basicConfig($framework, $appPath, $basePath, $appNamespace, $table, $options)
    {
        $config = [
            ...
            '_Str::camel_'               => ucfirst(Str::camel($table)),
            '_Str::camelPlural_'         => Str::plural(Str::camel($table)),
            ...
            '_Str::snake_'               => Str::snake($table),
            '_Str::snakePlural_'         => Str::plural(Str::snake($table)),
    ...
    public function configASectionedCRUD($config, $section, $table, $splitTable)
    {
        ...
        $sectionalConfig = [
            ...
            '_Str::camel_'               => ucfirst(Str::camel($splitTable[1])),
            '_Str::camelPlural_'         => Str::plural(Str::camel($splitTable[1])),
